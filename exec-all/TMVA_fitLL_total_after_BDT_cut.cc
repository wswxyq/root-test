...
int TMVA_fitLL_total_after_BDT_cut() {
    ...
    for (Long64_t i=0; i<nentries; i++) {
        ...
        if ( BDT_response_double > 0.484999 && D_M_double < 1939.65 && D_M_double >1799.65) {
    ...
    */
    ...
    //num total:94333
    RooRealVar gauss_poly_frac("gauss_poly_frac","fraction of component 1 in signal",100., 1200000) ;
    RooRealVar gauss_poly_frac_1("gauss_poly_frac_1","fraction of component 2 in signal",100., 1200000) ;
    ...
    c->Print("./LL/fit_mass_after_cut.pdf");
