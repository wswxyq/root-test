...
int TMVA_fit_DD_Dminus() {
    ...
    RooRealVar BDT_response("BDT_response", "BDT_response value", 0.439746, RooNumber::infinity());
    ...
    //num total:94333
    RooRealVar gauss_poly_frac("gauss_poly_frac","fraction of component 1 in signal",1000., 500000) ;
    RooRealVar gauss_poly_frac_1("gauss_poly_frac_1","fraction of component 2 in signal",1000., 500000) ;
    ...
    c->Print("./DD/fit_Dminus.pdf");

    x1.Print();
    x2.Print();
    x3.Print();
    mean.Print();
    sigma.Print(); /*alpha_var.Print(); n_var.Print();*/
