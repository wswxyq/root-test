...
void TMVA_GetBDTCut_DD()
{
    ...
    Double_t kk_signal_yield=2030.99;
    Double_t kk_background_yield=35648.5;
    Double_t kp_signal_yield=41126.7; //to fit
    Double_t kp_background_yield=122502; //to fit
    Double_t temp_sig=0.;
    Double_t temp_bkg=0.;
