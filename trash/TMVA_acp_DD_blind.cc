...
void TMVA_acp_DD_blind() {
    ...
    const char* TChain_file="./DD/TMVA_output_DD.root";
    ...
    RooRealVar mean("mean","mean of gaussian",1869.97) ;
    RooRealVar mean_1("mean_1","mean of gaussian(1)",1870.00) ;
    RooRealVar sigma("sigma","width of gaussian",10.8746) ;
    RooRealVar sigma_1("sigma_1","width of gaussian(1)",6.70189) ;
    RooGaussian gauss("gauss","gaussian PDF", D_M, mean, sigma) ;
    RooGaussian gauss_1("gauss_1","gaussian PDF(1)", D_M, mean_1, sigma_1) ;
    RooRealVar gauss_frac("gauss_frac","fraction of component 1 in signal",0.429745) ;
    RooAddPdf gauss_all("gauss_all", "combination of gaussian function", RooArgList(gauss, gauss_1), RooArgList(gauss_frac));


    RooRealVar x1("x1", "para1", 0.00531998);
    ...
    //signal------------------------------------------------------------------
    RooRealVar Ntot_plus("Ntot_plus", "Ntot_plus", 0., 100000.); //number of D+
    RooRealVar Ntot_minus("Ntot_minus", "Ntot_minus", 0., 100000.); //number od D-
    ...
    //background----------------------------------------------------------
    RooRealVar Ntot_bkg_plus("Ntot_bkg_plus", "Ntot_bkg_plus", 0., 100000.);
    RooRealVar Ntot_bkg_minus("Ntot_bkg_minus", "Ntot_bkg_minus", 0., 100000.);
